            ...
            MySofa[] arr =
{
        ...
        private static double SofaGenerator(int num)
        {
            ...
            */
            SofaWithResults result;
            switch (num)
            {
                case 1:
                    result = SofaGenerator1();
                    break;
                case 2:
                    result = SofaGenerator2();
                    break;
                default:
                    result = SofaGenerator3();
                    break;
            }
        ...
        private static double TwinListGrader(TwinListWithResult twinList, TwinList result, int type, int numTest)
        {
            ...
            */
            ...
            {
                case GET_CHAIN:
                    return GetChainGrader(twinList, result, numTest);
                case GET_EVEN:
                    return GetEvenGrader(twinList, result, numTest);
                case GET_ODD:
                    return GetOddGrader(twinList, result, numTest);
                default:
                    return SwitchChainGrader(twinList, result, numTest);
        ...
        private static double TwinListGenerator(int num)
        {
            ...
            */
            TwinListWithResult result;
            if (num == 1) result = TwinListGenerator1();
            else result = TwinListGenerator2();
            double grade = 0;
            TwinList twinList;
            try
            {
        ...
        private static double StackGenerator(int num)
        {
            ...
            */
            ...
            {
                case 1:
                    result = StackGenerator1();
                    break;
                case 2:
                    result = StackGenerator2();
                    break;
                case 3:
                    result = StackGenerator3();
                    break;
                case 4:
                    result = StackGenerator4();
                    break;
                default:
                    result = StackGenerator5();
                    break;
            }
        ...
        private static double TreeGenerator(int num)
        {
            ...
            */
            ...
            {
                case 1:
                    result = TreeGenerator1();
                    break;
                case 2:
                    result = TreeGenerator2();
                    break;
                case 3:
                    result = TreeGenerator3();
                    break;
                case 4:
                    result = TreeGenerator4();
                    break;
                case 5:
                    result = TreeGenerator5();
                    break;
                case 6:
                    result = TreeGenerator6();
                    break;
                case 7:
                    result = TreeGenerator7();
                    break;
                default:
                    result = TreeGenerator8();
                    break;
            }
            if (num <= 4)
